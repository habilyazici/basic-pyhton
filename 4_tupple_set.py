...
# Set yapıları sırasız ve listelerin aksina tek yapılardır yani sette oluşturulan verilerin bir sırası yoktur. Ve aynı veriler tek gözükür.
...
print(sehirler)
# remove de sette olmayan bir elemanı silersen hata alırsın ama discardda hata mata yok.
