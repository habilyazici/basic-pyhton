...
for x in friends:
    if x == 'selim':
        continue
    print(x)
# Burada while ve for farkını görebilirsin. While da sayaç kullanılmaktadır.
...
print('1 den girdiğiniz sayıya kadar olan tüm sayılar toplanacaktır(maximum 1000\'e kadar toplama işlemi yapılır)')
