...
print(len(name))
print(name[0])  #1
print(name[2:7])  #2 index olarak söylüyor ikinci indexten başlarım diyor yani.
print(name[:5])  #3
print(name[3:])  #4
print(name[-1])  #5
...
print(my_string)
print(my_string2)
# Stringler item assigmant'i desteklememektedir. Yani item değiştirmeyi desteklemez.
